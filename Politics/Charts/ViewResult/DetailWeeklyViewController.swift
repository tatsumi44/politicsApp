...
class DetailWeeklyViewController: DemoBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let ques_array = [String](question.array.keys)
...
extension DetailWeeklyViewController{
    ...
    func setDataCount(xValArr: [String], yValArr: [String:[Double]]) {
        ...
        let array = [String](question.array.keys)
        ...
        case 3:
            ...
            let set1 = LineChartDataSet(values: yVals1, label: question.array[array[0]])
            ...
            let set2 = LineChartDataSet(values: yVals2, label: question.array[array[1]])
            ...
            let set3 = LineChartDataSet(values: yVals3, label: question.array[array[2]])
        ...
        case 4:
            ...
            let set4 = LineChartDataSet(values: yVals3, label: question.array[array[2]])
        ...
        case 5:
            ...
            let set4 = LineChartDataSet(values: yVals4, label: question.array[array[3]])
            set4.axisDependency = .right
            set4.setColor(bgolors[3] as! UIColor)
            set4.setCircleColor(.white)
            set4.lineWidth = 2
            ...
            let set5 = LineChartDataSet(values: yVals5, label: question.array[array[4]])
        ...
        case 6:
            ...
            let set6 = LineChartDataSet(values: yVals6, label: question.array[array[5]])
        ...
        case 7:
            ...
            let set7 = LineChartDataSet(values: yVals7, label: question.array[array[6]])
